"""SwinIR wrapper adapted for solar magnetogram super-resolution.

Based on: SwinIR: Image Restoration Using Swin Transformer
...
class SwinIRNet(nn.Module):
    """SwinIR adapted for solar magnetogram super-resolution.

    Key changes from original:
    - No RGB mean subtraction (grayscale solar data)
    - Configurable in/out channels
    - Uses pixelshuffledirect for efficient upsampling
    """
    ...
    def __init__(
        ...
        # No RGB mean for grayscale solar data - use zero mean
        ...
        # Lightweight upsampling (pixelshuffledirect)
        self.upsample = nn.Sequential(
            nn.Conv2d(embed_dim, (scale**2) * out_channels, 3, 1, 1),
